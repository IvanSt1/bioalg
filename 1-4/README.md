...
#### Результаты
![вероятность мутации](./вероятность мутации.png)
![количество поколений](./количество поколений.png)
![количество родителей](./количество родителей.png)
![размер популяции](./размер популяции.png)
